...
class UI {
    ...
    private int getUserInput() {
        String[] action = { "1.Convert Hexadecimal To Decimal", 
                            ...
                            "8.Nothing" };
        String whatToDo = (String) JOptionPane.showInputDialog(null, "What do you want to do?", "Action",
    ...
    private void compareTwoHex() {
        ...
        String[] action = { "1.Two Hexadecimal Numbers Are Equal?",
                            ...
                            "4.Nothing" };
        do {
            String compare = (String) JOptionPane.showInputDialog(null, "What do you want to Check?",
                                                                        "Comparison Of Two Hexadecimal Numbers", JOptionPane.QUESTION_MESSAGE, null, action, action[0]);
            localChoice = Character.getNumericValue(compare.charAt(0));
            switch (localChoice) {
            case 1:
